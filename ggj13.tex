...
%Iterative development planned for the engine used to be the final game engine, rather than later switching implementation.
...
%Working with group members, meeting time constraints, making art, and fixing game bugs were also important challenges.
%Scoping, game balance, converting concepts into code, and conceptualization were lesser issues.
...
%Scope reduction involved cutting planned features, cutting components of a system or whole mechanics, substituting complex mechanics with simpler alternatives, or removing interface or story elements (138 of 278).
